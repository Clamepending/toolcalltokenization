...
const CAMPAIGNS = {
  ...
  amazon_cart: [
    "Go to https://www.amazon.com/, search for black crew socks men, open a plausible first product result, add the item to cart if possible, stop before checkout, and report exactly this JSON: {\"status\":\"success\",\"product_title\":\"<title>\",\"added_to_cart\":true,\"cart_signal\":\"<evidence or unknown>\"}. If you cannot add it, return {\"status\":\"error\",\"error\":\"<what went wrong>\"}.",
    "Go to https://www.amazon.com/, search for white ankle socks women, open a plausible first product result, add the item to cart if possible, stop before checkout, and report exactly this JSON: {\"status\":\"success\",\"product_title\":\"<title>\",\"added_to_cart\":true,\"cart_signal\":\"<evidence or unknown>\"}. If you cannot add it, return {\"status\":\"error\",\"error\":\"<what went wrong>\"}.",
    "Go to https://www.amazon.com/, search for blue bath towels set, open a plausible first product result, add the item to cart if possible, stop before checkout, and report exactly this JSON: {\"status\":\"success\",\"product_title\":\"<title>\",\"added_to_cart\":true,\"cart_signal\":\"<evidence or unknown>\"}. If you cannot add it, return {\"status\":\"error\",\"error\":\"<what went wrong>\"}.",
    "Go to https://www.amazon.com/, search for stainless steel water bottle, open a plausible first product result, add the item to cart if possible, stop before checkout, and report exactly this JSON: {\"status\":\"success\",\"product_title\":\"<title>\",\"added_to_cart\":true,\"cart_signal\":\"<evidence or unknown>\"}. If you cannot add it, return {\"status\":\"error\",\"error\":\"<what went wrong>\"}.",
    "Go to https://www.amazon.com/, search for usb c cable 6ft, open a plausible first product result, add the item to cart if possible, stop before checkout, and report exactly this JSON: {\"status\":\"success\",\"product_title\":\"<title>\",\"added_to_cart\":true,\"cart_signal\":\"<evidence or unknown>\"}. If you cannot add it, return {\"status\":\"error\",\"error\":\"<what went wrong>\"}.",
    "Go to https://www.amazon.com/, search for notebook journal hardcover, open a plausible first product result, add the item to cart if possible, stop before checkout, and report exactly this JSON: {\"status\":\"success\",\"product_title\":\"<title>\",\"added_to_cart\":true,\"cart_signal\":\"<evidence or unknown>\"}. If you cannot add it, return {\"status\":\"error\",\"error\":\"<what went wrong>\"}.",
  ],
  amazon_checkout_preview: [
    "Go to https://www.amazon.com/, search for black crew socks men, open a plausible first product result, add it to cart if possible, proceed as far toward checkout as possible without placing any order, and report exactly this JSON: {\"status\":\"success\",\"product_title\":\"<title>\",\"reached_checkout\":true,\"checkout_signal\":\"<evidence or unknown>\"}. If checkout is blocked by sign-in, address, or any other issue, return {\"status\":\"error\",\"error\":\"<what blocked progress>\"}.",
    "Go to https://www.amazon.com/, search for white ankle socks women, open a plausible first product result, add it to cart if possible, proceed as far toward checkout as possible without placing any order, and report exactly this JSON: {\"status\":\"success\",\"product_title\":\"<title>\",\"reached_checkout\":true,\"checkout_signal\":\"<evidence or unknown>\"}. If checkout is blocked by sign-in, address, or any other issue, return {\"status\":\"error\",\"error\":\"<what blocked progress>\"}.",
    "Go to https://www.amazon.com/, search for usb c cable 6ft, open a plausible first product result, add it to cart if possible, proceed as far toward checkout as possible without placing any order, and report exactly this JSON: {\"status\":\"success\",\"product_title\":\"<title>\",\"reached_checkout\":true,\"checkout_signal\":\"<evidence or unknown>\"}. If checkout is blocked by sign-in, address, or any other issue, return {\"status\":\"error\",\"error\":\"<what blocked progress>\"}.",
  ],
  newegg_search: [
